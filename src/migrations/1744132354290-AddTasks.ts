...
export class AddTasks1744132354290 implements MigrationInterface {
    name = 'AddTasks1744132354290'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "task" ("id" SERIAL NOT NULL, "taskName" character varying NOT NULL, "completed" boolean NOT NULL, "userId" integer, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
